      ...
      >
        <div className="rounded-3xl border border-primary-500/30 bg-[#050505] shadow-[inset_0_0_40px_rgba(88,37,216,0.15)] p-10">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3.5 rounded-md bg-gradient-to-b from-primary-500 to-primary-700 text-white font-semibold text-sm border border-white/20 shadow-[0_0_24px_rgba(88,37,216,0.4)] hover:shadow-[0_0_40px_rgba(88,37,216,0.6)] transition-all duration-300"
            >
              Sign In
            </button>
          </form>
